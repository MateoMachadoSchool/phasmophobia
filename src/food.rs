...
img_fronthall.set_preload(tm.get_preload("assets/foodroom.png").unwrap());
...
img_hitboxfront.set_preload(tm.get_preload("assets/foodhitboxs.png").unwrap());

let mut img_hitboxdoors = StillImage::new("",2000.0,1068.0,0.0,100.0,true,1.0,).await;
img_hitboxdoors.set_preload(tm.get_preload("assets/Fooddoors.png").unwrap());
...
let mut img_player = StillImage::new("",70.0,70.0,200.0,800.0,true,1.0,).await;
