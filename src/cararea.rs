...
img_fronthall.set_preload(tm.get_preload("assets/cararea.png").unwrap());
...
img_hitboxfront.set_preload(tm.get_preload("assets/carhitboxes.png").unwrap());

let mut img_hitboxdoors = StillImage::new("",2000.0,1068.0,0.0,100.0,true,1.0,).await;
img_hitboxdoors.set_preload(tm.get_preload("assets/cardoors.png").unwrap());
...
let mut img_player = StillImage::new("",70.0,70.0,250.0,450.0,true,1.0,).await;
